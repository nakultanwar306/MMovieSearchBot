...
url_list = {}
api_key = "f61ed0df636332fd0ea6b6ea7ec77abc0693567b"
...
def get_movie(query):
    ...
    if movie_page_link:
        ...
        final_links = {}
        for i in links:
            url = f"https://urlshortx.com/api?api=f61ed0df636332fd0ea6b6ea7ec77abc0693567b&url=yourdestinationlink.com&alias=CustomAlias&format=text"
